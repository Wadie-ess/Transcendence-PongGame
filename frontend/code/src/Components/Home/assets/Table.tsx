                ...
                >
                  ...
                  <td className="flex justify-start items-center gap-x-2 hover:cursor-pointer">
                    <Link to={`/Profile/${x.userId}`}>
                      <div className="flex justify-start items-center gap-x-2 hover:cursor-pointer">
                        ...
                        <div className="flex font-montserrat w-20 text-neutral font-semibold ">
                          {x?.Username}
                        </div>
                      </div>
                    </Link>
                  </td>
                  <td className="flex justify-start items-center gap-x-1 w-18">
                    <Daimond /> <div>{x?.wins}</div>
                  </td>
                </tr>
              ))}
