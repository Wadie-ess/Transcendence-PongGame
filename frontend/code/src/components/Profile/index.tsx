    ...
    <Layout>
        <div className="flex flex-col items-center h-full min-h-screen">
            <div className='relative  pt-12 h-auto max-h-[50vh] w-[85vw]'>
                ...
                <Pong/>           
                <div className="avatar w-[10vw] absolute z-40 -bottom-6 sm:-bottom-11 left-6 sm:left-12 ">
            ...
            <div className='relative flex flex-col gap-y-2 sm:gap-y-0 pl-4 pt-12 text-neutral font-montserrat bg-base-200  justify-start  items-start h-[35%] min-h-[30%] rounded-b-3xl w-[85vw] overflow-scroll no-scrollbar'>
                <h6>Mark Zzzz</h6>
